...
__all__ = ['ReverseLayerF', 'RandomNetworkWithReverseGrad', 'mygradientreversalnet']
...
class RandomNetworkWithReverseGrad(nn.Module):
    def __init__(self, num_classes=1000, num_domains=2, **kwargs):
...
def mygradientreversalnet(pretrained=False, progress=True, **kwargs):
